...
//
//   ///the drawer that hidden in the below
//   final Widget drawer;
//
//   const SlideStack({Key key, this.drawer, this.child}) : super(key: key);
//
//   @override
//   _SlideStackState createState() => _SlideStackState();
// }
//
// class _SlideStackState extends State<SlideStack> {
//   @override
...
//
//   ///the min auto slide distance when the gesture ends
//   final double minAutoSlideDistance;
//
//   ///the max of the slide size
//   final double maxSlideDistance;
//
//   ///the duration of the auto slide
//   final Duration autoSlideDuration;
//
//   ///the damping of the slide it must >=1.0
//   final double slideDampening;
//
...
//
//   ///Called on each time when the slide gesture is active
//   ///
//   /// returns the position of the drawer between 0.0 and 1.0
//   final ValueChanged<double> onSlide;
//
//   ///called when the drawer starts is full opened
//   final VoidCallback onSlideCompleted;
//
//   ///called when the drawer canceled
...
//         assert(minAutoSlideDistance != null),
//         assert(maxSlideDistance != null),
//         assert(autoSlideDuration != null),
//         assert(slideDampening != null && slideDampening >= 1.0),
//         super(key: key);
//
//   @override
//   SlideContainerState createState() => SlideContainerState();
// }
//
...
//   void initState() {
//     animationController =
//         new AnimationController(vsync: this, duration: widget.autoSlideDuration)
//           ..addListener(() {
...
//       } else {
//         dragTarget += (dragValue - dragTarget) / widget.slideDampening;
//       }
//       animationController.value = dragTarget.abs() / widget.maxSlideDistance;
//     });
//
...
//           GestureRecognizerFactoryWithHandlers<T>(constructor, (T instance) {
//             instance
...
//     animationController.fling(velocity: isOpen ? -2.0 : 2.0).then((value) => print(
//         'animationController.value:${animationController.value},dragTarget:$dragTarget'));
//   }
//
//   void _completeSlide() => animationController.forward().then((value) =>
...
//     dragTarget = dragValue;
//     fingerTicker.start();
//     if (widget.onSlideStart != null) widget.onSlideStart();
//   }
//
...
//       _cancelSlide();
//     } else {
//       dragTarget.abs() > widget.minAutoSlideDistance
//           ? _completeSlide()
//           : _cancelSlide();
//     }
//     fingerTicker.stop();
...
class ContainerState extends State<SlideContainer>
  ...
  double get containerOffset =>
      animationController.value * maxDragDistance ;
  ...
  void openOrClose() {
    ...
    animationController.fling(velocity: isOpen ? -2.0 : 2.0).then((_) {
      print("animationController.value:${animationController
          .value},dragTarget:$dragTarget");
    });
  }
